        ...
        <div class="container">
            ...
            <div class="hor-menu  ">
                <ul class="nav navbar-nav">
                    @section('menu')
                    <li class="menu-dropdown classic-menu-dropdown {{ Request::is('/') ? 'active' : '' }}">
                        <a href="{{ config('app.url') }}/"> Home </a>
                    </li>
                    <li class="menu-dropdown classic-menu-dropdown {{ Request::is('profile') ? 'active' : '' }}">
                        <a href="{{ config('app.url') }}/profile"> My Profile </a>
                    </li>
                    <li class="menu-dropdown classic-menu-dropdown {{ Request::is('subscribers') ? 'active' : '' }}">
                        <a href="{{ config('app.url') }}/subscribers"> My Subscribers </a>
                    </li>
                    @show
                </ul>
            </div>
...
<div class="page-footer">
    <div class="container"> 2017 &copy; Profile Channels</div>
</div>
